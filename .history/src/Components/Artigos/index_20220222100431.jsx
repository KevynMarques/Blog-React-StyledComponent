    ...
    <SubTitle>
      ...
      <ContainerBox>
       ...
       <TitleInfo>Ansiedade</TitleInfo>
        Cães ansiosos são um dos quadros comportamentais mais tristes que podemos ver, infelizmente as pessoas que não buscam conhecimento adequado sobre o comportamento canino acabam confundo ansiedade com FELICIDADE e não é bem assim que as coisas funcionam. Cães ansiosos são cães angustiados e sempre na expectativa de algo acontecer, alguns urinam, outros choram e latem sem parar, alguns chegam ao ponto de se multilar ou ter comportamentos compulsivos como lamber as patas e correr a traz do rabo, se seu cão tem alguns desses sintomas, procure um profissional para te ajudar o mais rapido possivel, não deixe seu animal ficar sofrendo porque ele parece bonitinho nesse estado. 
        </Info>
       </ContainerBox> 
