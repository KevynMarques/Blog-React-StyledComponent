  ...
  return (
    ...
    <SubTitle>
      ...
      <ContainerBox>
       ...
       da melhor forma possivel ter esse tipo de atitude ? Muitas pessoas se enganam achando que muito amor e carinho são o suficente para o animal ser grato e respeitar as pessoas da casa porem estam completamente enganados, cães precisam de uma rotina e de limites igual uma criança, uns precisaram de uma rotina mais rigina e outros menos, mas o importante é mostrarmos que NÓS os donos somos quem estabelece esses limites, você dono de um cão precisa aprender a se comunicar e mostrar que o provedor dessa vida maravilhosa que seu cão tem e assim que isso estiver claro para ele você tera o respeito  
        </Info>
       </ContainerBox> 
