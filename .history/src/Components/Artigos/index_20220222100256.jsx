  ...
  return (
    ...
    <SubTitle>
      ...
      <ContainerBox>
       ...
       da melhor forma possível a ter esse tipo de atitude? Muita gente se engana achando que dando amor e carinho já seria o suficente para o animal ser grato e respeitar as pessoas da casa, porém estão completamente enganados, cães precisam de uma rotina e de limites igual uma criança, uns precisaram de uma rotina mais rigia e outros menos, mas o importante é mostrarmos que NÓS os donos somos quem estabelece esses limites, você dono de um cão precisa aprender a se comunicar e mostrar que o provedor dessa vida maravilhosa que seu cão tem, assim que isso estiver claro para ele você tera o respeito que merece e não ocorrera mais mordidas.
        </Info>
       </ContainerBox> 
