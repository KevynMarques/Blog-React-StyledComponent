    ...
    <SubTitle>
      ...
      <ContainerBox>
       ...
       <TitleInfo>Destruição de objetos</TitleInfo>
        Esse é um assunto que todos nós donos de cães deveriamos dar mais atenção, existem inumeras causas e motivos para um cão destuir algo mas os mais comuns são ansiedade por separação onde o cão procura destruir objetos que possuam cheiro do dono ou que eles percebem que no dia a dia o dono acaba dando mais atenção ou valor para esse objeto como alguma tentativa de interação com o dono, e temos o classico " tédio" onde o dono não oferece atividade fisica e mental o suficiente para o cão não procurar o que fazer e assim ele acaba arrumando algo para se destrair e DESTRUIR, e por ultimo temos a causa mais comum, ele destroi porque tem acesso, quando adquirimos um animal seja  por meio de adoação o
        </Info>
       </ContainerBox> 
    </>
  );
