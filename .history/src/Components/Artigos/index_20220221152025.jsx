  ...
  return (
    ...
    <SubTitle>
      ...
      <ContainerBox>
       ...
       da melhor forma possivel ter esse tipo de atitude ? Muitas pessoas se enganam achando que muito amor e carinho são o suficente para o animal ser grato e respeitar as pessoas da casa porem estam completamente enganados, cada cão nasce com uma personalidade própria então não adianta comparar com outro animalzinho que foi criado no mesmo jeito ou com o animalzinho da vizinha, devemos respeitar 
        </Info>
       </ContainerBox> 
