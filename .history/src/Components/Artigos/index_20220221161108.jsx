  ...
  return (
    ...
    <SubTitle>
      ...
      <ContainerBox>
       ...
       O Passeio é uma das questões mais importantes na vida de um cão e seu dono, no passeio se tem momentos prazerosos tanto para dono como para o seu cão, infelizmente temos uma demonização e detração de inumeras ferramentas que auxiliam 
        </Info>
       </ContainerBox> 
