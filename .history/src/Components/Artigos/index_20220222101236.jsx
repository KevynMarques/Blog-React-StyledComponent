    ...
    <SubTitle>
      ...
      <ContainerBox>
       ...
       <TitleInfo>Destruição de objetos</TitleInfo>
        Esse é um assunto que todos nós donos de cães deveriamos dar mais atenção, existem inumeras causas e motivos para um cão destuir algo mas os mais comuns são: ansiedade por separação, onde o cão procura destruir objetos que possuam o cheiro do dono ou que eles percebem que no dia a dia o dono acaba dando mais atenção/valor para esse objeto como alguma tentativa de interação com o dono; temos o classico " tédio" onde o dono não oferece atividade física e mental o suficiente para o cão não procurar o que fazer e assim ele acaba arrumando algo para se destrair e DESTRUIR; e por último temos a causa mais comum, ele destrói porque tem acesso, quando adquirimos um animal seja por meio de adoação o até mesmo comprando, é nossa responsabilidade suprir todas as necessidades físicas e mentais do animal e por fim somos responsáveis pela supervisão dele !
        </Info>
       </ContainerBox> 
    </>
  );
