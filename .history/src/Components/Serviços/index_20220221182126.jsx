  ...
  return (
    ...
    <SubTitle>
      ...
      <ContainerBox>
       ...
       <br></br> <br></br> 
       Treinamento itensivo : O cão ficara hospedado em minha residencia por no minimo 15 dias onde tera uma rotina de treinos com objetivo de melhorar comportamentos indesejados e 
        </Info>
       </ContainerBox> 
