    ...
    <img src={Dog} />
      ...
      <ContainerBox>
       ...
       <TitleInfo>Bucky</TitleInfo>
        O Bucky é um srd bem peculiar, na rotina do adestramento acabamos sempre caindo nos problemas mais comuns porem com ele foi diferente, quando cheguei a residencia não dei muito valor a   
        </Info>
       </ContainerBox> 
    </>
  );
